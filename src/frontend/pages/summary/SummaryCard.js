...
export default function SummaryCard(props) {
  ...
  useEffect(() => {
    ...
    setDateOfOrder({
      date: orderDateModified.getDate(),
      month: months[orderDateModified.getMonth()],
      year: orderDateModified.getFullYear(),
    });
    let etaModified = new Date(eta);
    setEtaDate({
      date: etaModified.getDate(),
      month: months[etaModified.getMonth()],
      year: etaModified.getFullYear(),
    });
  }, [orderDate, eta]);
